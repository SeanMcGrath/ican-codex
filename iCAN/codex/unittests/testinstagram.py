...
from codex.scripts.instagram import InstagramOauthClient, searchForLocation
...
class TwitterTests(unittest.TestCase):
	...
	def test_TwitterOauthClient(self):
		with patch('codex.scripts.instagram.requests') as mock_requests:
	...
	def test_searchForLocation(self):
		with patch('codex.scripts.instagram.searchForLocation') as mock_searchForLocation:
