...
from codex.scripts.tumblr import *
import oauth2
import urlparse
...
class TestTumblr(unittest.TestCase):
	...
	#	with patch('codex.scripts.tumblr.TumblrOauthClient.authorize_url') as mock_get_authorize_url:
	...
	#		link = "http://www.tumblr.com/oauth/authorize?oauth_token="+self.oauth_token+"&redirect_uri=http%3A%2F%2Flocalhost%3A8000/codex/tumblr"
