...
from codex.scripts.github import getUserData, getUserRepositories, getForkedRepositories, getTopContributedRepositories, getStarGazerCount, filterStarGazerCount, filterCommits
...
class GithubTests(unittest.TestCase):
	...
	def testGetUserData(self):
		...
		with patch('codex.scripts.github.getUserData') as mock_getUserData:
	...
	def testGetUserRepositories(self):
		...
		repositories = []
		while True:
			with patch('codex.scripts.github.getUserRepositories') as mock_getUserRepositories:
	...
	def testGetForkedRepositories(self):
		...
		while True:
			with patch('codex.scripts.github.getUserRepositories') as mock_getForkedRepositories:
		...
		forkedRepositories = [{'name': 'async'}, {'name': 'FizzBuzz-Test-1'}, {'name': 'codex-starter'}, {'name': 'historicalWeather'}, {'name': 'jsrecipes'}, {'name': 'node'}, {'name': 'rst2pdf'}, {'name': 'rust-by-example'}, {'name': 'satellizer'}, {'name': 'vitanao'}, {'name': 'WaterEmblem'}, {'name': 'webauth-via-ssh'}]
	...
	def testGetTopContributedRepositories(self):
		...
		jsonList = []
		for repo in repos:
			with patch('codex.scripts.github.getTopContributedRepositories') as mock_getTopContributedRepositories:
	...
	def testGetStarGazerCount(self):
		...
		while True:
			with patch('codex.scripts.github.getStarGazerCount') as mock_getStarGazerCount:
