...
from codex.serializers import SnippetSerializer
from codex.forms import UserForm
...
def index(request):
    ...
    context = {'hello': 'world'}
    return render(request, 'codex/index.html', context)
...
def api_examples(request):
    ...
    return render(request, 'codex/api_examples.html', context)
...
def steam(request):
    ...
    return render(request,'codex/steam.html', {"game": game })
...
def facebook(request):
    ...
    '''
    userInfo = getFacebook.get_user_info()
    return render(request, 'codex/facebookAPIExample.html', { 'userInfo' : userInfo})
...
def googlePlus(request):
    ...
    userInfo = getGoogle.get_user_info()
    return render(request, 'codex/googlePlus.html', {'userInfo' : userInfo})
...
def dropbox(request):
    userInfo = getDropbox.get_user_info()
    return render(request, 'codex/dropbox.html', {'userInfo' : userInfo})
...
def dropboxSearchFile(request):
    if request.method == 'POST':
        ...
        return render(request, 'codex/dropboxSearchFile.html', {'data': response.json()})
...
def foursquare(request):
    userInfo = getFoursquare.get_user_info()
    return render(request, 'codex/foursquare.html', {'data' : userInfo})
...
def yelp(request):
    ...
    return render(request, 'codex/yelp.html', { 'data': data })
...
def meetup(request):
    REDIRECT_URI = 'http://127.0.0.1:8000/codex/meetupToken'
...
def meetupToken(request):
    ...
    return HttpResponseRedirect('http://127.0.0.1:8000/codex/meetupUser/')

def meetupUser(request):
    if not MeetupToken.objects.all().exists():
        return HttpResponseRedirect('http://127.0.0.1:8000/codex/meetup')
    ...
    return render(request, 'codex/meetup.html', { 'data': meetupData })
...
def quandlstocks(request):
    ...
    return render(request, 'codex/quandl.html', { 'everyData': everyData })
...
def nytimesarticles(request):
    ...
    return render(request, 'codex/nytimes.html', { 'everyData': everyData })
...
def githubUser(request):
    ...
    return render(request, 'codex/github.html', {'data': parsedData})
...
def githubTopRepositories(request):
    ...
    if request.method == 'POST':
        ...
        print parsedData
    return render(request, 'codex/githubTopRepositories.html', {'data': parsedData})
...
def githubResume(request):
    ...
    return render(request, 'codex/githubResume.html', { 'data': allData })
...
def tumblr(request):
    ...
    return render(request, 'codex/tumblr.html', context)
...
def instagram(request):
    ...
    return render(request, 'codex/instagram.html', context)
...
def instagramMediaByLocation(request):
    ...
    return render(request, 'codex/instagram_q.html', context)
...
def twitter(request):
    ...
    return render(request, 'codex/twitter.html', context)
...
def twitterTweets(request):
    ...
    return render(request, 'codex/twitter_tweet.html', context)
...
def linkedin(request):
    ...
    return render(request, 'codex/linkedin.html', context)
...
def twilio(request):
    if request.method == 'POST':
        ...
        return HttpResponseRedirect('/codex/api/')
    return render(request, 'codex/twilio.html')
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            user.save()
            registered = True
            return HttpResponseRedirect('/codex/login/')
        else:
